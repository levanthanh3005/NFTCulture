...
export default class Product extends BlockchainAPI {
  ...
  async loadData() {
    ...
    // console.log(parsed);
    var fileHash = window.location.toString().split("/").pop();
    ...
    var information = (<>
        <span>{"- Still bidding?:"+(result[1]==true ? "Yes, lets bidding" : "No, the bid has been stopped!, the owner now is the latest bidder")}</span><br/>
  ...
  async newBid(event) {
    try {
      const result = await this.contract.startBid(this.state.fileHash, this.state.newPrice, {
        gasPrice: '20000000000',
      })
      console.log('result', result)
  ...
  async buyToken(event) {
    try {
      const result = await this.contract.buy({
        gasPrice: '20000000000',
        value: ethers.utils.parseUnits(this.state.ethToConvert, "ether"),
      })
      console.log('result', result)
          ...
          <div className="row">
            <div className="col-xs-12 col-sm-6">
              <div className="product-name">
                <h1 className='title text-center'>{this.state.name}</h1>
              </div>
              <ProductImageCarousel images={this.state.images} />
            </div>
            <div className="col-xs-12 col-sm-6">
              <div className="product-price">
                <h3> Latest Bid: {this.state.price} <span className="lead">NFT</span></h3>
              </div>

              <div className="product-offers left-text">
                ...
                ? (<div className="product-buy-actions">
                  <div className="row no-gutter">
                      <div className="col-xs-12 col-sm-6">
                        ...
                        <input className="btn-lg btn-full" 
                        ...
                        <div className="col-xs-12 col-sm-6">
                          <button className="btn btn-primary btn-lg btn-full" onClick={this.newBid.bind(this)}>Lets bid</button>
                        </div>
                  </div>
                  ...
                  <div className="row no-gutter">
                      <div className="col-xs-12 col-sm-6">
                        ...
                        <input className="btn-lg btn-full" 
                                        value={this.state.ethToConvert} 
                                        onChange={(e)=>this.handleInputChange(e)} 
                                        name="ethToConvert" 
                                        type="number" 
                                        placeholder="Your Eth To buy here"
                                        />

                        </div>
                        <div className="col-xs-12 col-sm-6">
                          <button className="btn btn-secondary btn-lg btn-full" onClick={this.buyToken.bind(this)}>Buy Token</button>
                        </div>                        

                  </div>

                  <span className="theme-offers"><br/>{this.state.alertMessages}</span>
              ...
              <div className="">
                ...
                <ul className="product-offers left-text">
